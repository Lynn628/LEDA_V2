...
import com.seu.ldea.segment.DatasetSegmentation.GapInfo;
...
public class DatasetSegmentation2 {
	// 每个资源的id以及携带的时间信息
		...
		private DatasetSegmentation2(HashMap<Integer,ResourceInfo> resourceTimeInfo,
		...
		public static DatasetSegmentation2 initDataSegment(String path, String classPTName, String rescalInputDir) throws IOException, ParseException{
			...
			HashMap<Integer, ResourceInfo> typedresourceTimeInfo = LabelClassWithTime.resourceTimeInfo;
			...
			DatasetSegmentation2 datasetSegmentation2 = new DatasetSegmentation2(typedresourceTimeInfo, interactiveMatrix);
		 ...
		 */
		public static DatasetSegmentation2 initDataSegment(String path,HashMap<Integer, ResourceInfo> typedresourceTimeInfo, String path2, String rescalInputDir) throws IOException, ParseException{
			HashMap<Integer, ResourceInfo> noTypeResourceTimeInfo = BuildFromFile.getResourceTimeInfo(path);
			LabelClassWithTime.resourceTimeInfo = noTypeResourceTimeInfo;
			//这一步不能省，resource被标上类型信息
		...
		public static void main(String[] args) throws IOException, ParseException {
			...
			HashMap<Integer, HashMap<String, TimeSpan>> classPTMap = LabelClassWithTime.getClassTimeSpanInfo(classTimeInfo,
					"");
			HashMap<Integer, HashMap<String, TimeSpan>> interactiveMatrix = InteractiveMatrix.getInteractiveMatrix(classPTMap);
			DatasetSegmentation2 datasetSegment = new DatasetSegmentation2(resourceTimeInfo, interactiveMatrix);
			HashMap<Integer, HashSet<Integer>> slices = datasetSegment.segmentDataSet(2049, "http://www.w3.org/2002/12/cal/ical#dtstart");
			...
			LinkedHashMap<Integer, HashSet<Integer>> timeEntitySlices = DatasetSegmentation2.initDataSegment(path, " ", rescalInputDir).segmentDataSet(161771, "http://purl.org/dc/elements/1.1/date");
