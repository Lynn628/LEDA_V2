...
public class LabelClassWithTime {
	// 每个资源的id以及携带的时间信息
		...
		public LabelClassWithTime(HashMap<Integer, ResourceInfo> resourceTimeInfo) {
		super();
		...
		/*	Dataset dataset = new Dataset("jdbc:virtuoso://localhost:1111", "http://LDEA/SWCC.org", "dba", "dba");
			...
			LabelClassWithTime labelClass = new LabelClassWithTime(resourceTimeInfo);
